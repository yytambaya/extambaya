            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        <small class="small-text">Welcome to <span class="mobile-block">extambaya</span></small>
                        <h1 class="animated animated-text">
                            <span class="mr-2">What we do at</span>
                                <div class="animated-info">
                                    <span class="animated-item"><i>ex</i>tambaya</span>
                                    <span class="animated-item"><i>ex</i>tambaya</span>
                                    <span class="animated-item"><i>ex</i>tambaya</span>
                                </div>
                        </h1>

                        <p>We provide you with the latest exchange rates including the historical rate across the globe. The currency information is updated every unit time.</p>
